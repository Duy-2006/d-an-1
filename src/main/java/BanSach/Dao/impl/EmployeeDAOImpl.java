...
public class EmployeeDAOImpl implements EmployeeDAO {
   ...
   String insertSql = "INSERT INTO Employee (EmployeeID, FullName, PhoneNumber, Username, Password, Role, Status, SecurityQuestion, SecurityAnswer) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    String updateSql = "UPDATE Employee SET FullName = ?, PhoneNumber = ?, Password = ?, Role = ?, Status = ?, SecurityQuestion = ?, SecurityAnswer = ? WHERE EmployeeID = ?";
...
Object[] values = {
            ...
            entity.isRole(),
            entity.isStatus(),
            entity.getSecurityQuestion(),
            entity.getSecurityAnswer()
        };
